...
def capture_rgb_depth_dataset(
    ...
    set_size_resp = client.request(f"vset /camera/{resolved_camera_id}/size 1280 960")
    _assert_unrealcv_ok(set_size_resp, f"setting camera size for camera={resolved_camera_id}")
